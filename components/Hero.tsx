  ...
  return (
    <section className="bg-black">
      <div className="mx-auto max-w-7xl px-4 pb-0 pt-6 sm:px-6 lg:px-8">
        ...
        {/* Main heading */}
        <h1 className="font-heading mt-10 text-5xl font-black uppercase leading-[0.9] tracking-tight text-white sm:text-6xl md:text-7xl lg:text-8xl">
          THE ROOFERS
          <br />
          YOUR NEIGHBORS
          <br />
        ...
        <div className="mt-10 flex flex-col items-start justify-between gap-8 pb-10 md:flex-row md:items-end">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 border border-gray-600 bg-transparent px-7 py-4 text-sm font-bold uppercase tracking-wide text-white transition-colors hover:border-gray-400"
            >
              {/* Phone icon */}
              <svg
                className="h-4 w-4"
          ...
          {/* Right - tagline */}
          <p className="max-w-xs text-right text-sm italic text-gray-400 md:max-w-sm">
